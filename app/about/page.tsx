      ...
      <div className="mx-auto max-w-3xl border-x border-gray-200 px-6 py-6 text-center md:px-4 lg:px-6">
        <div className="space-y-6 text-center text-lg leading-relaxed sm:space-y-6 sm:text-left">
          <p className="text-panda-text text-lg leading-8 text-pretty">
            ...
            Jetpack Compose. I help people solve real-world problems by building
            Android apps. I live in Walnut Creek, California with my wife and
            daughter.
          </p>
          <p className="text-panda-text text-lg leading-8 text-pretty">
          ...
          <section className="space-y-6" aria-labelledby="early-apps-heading">
            ...
            <p className="text-panda-text text-lg">
              ...
              development journey and released my first two apps in 2012, built
          ...
          >
            ...
            />
            <p className="text-panda-text text-lg">
              To support my Android apps with modern backends and landing pages,
              I learned Next.js, React, and TailwindCSS. I built and published
              two full-stack Next.js apps that earned over{" "}
              <Link
